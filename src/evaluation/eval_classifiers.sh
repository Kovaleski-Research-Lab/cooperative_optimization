...
python evaluation.py --checkpoint_path '/develop/results/classifier_baseline_bench_resampled_sample/version_4/'
...
python evaluation.py --checkpoint_path '/develop/results/classifier_baseline_bench_sim_output/version_4/'
...
python evaluation.py --checkpoint_path '/develop/results/classifier_baseline_bench_bench_image/version_4/'
