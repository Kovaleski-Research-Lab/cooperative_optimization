...
if __name__ == "__main__":
    ...
    for i,focal_length in enumerate(tqdm(focal_length_sweep, desc='Focal Length Sweep')):
        ...
        temp_image_metrics = []
        temp_feature_metrics = []
        temp_classifier_metrics = []
        ...
        with torch.no_grad():
            for j, d in enumerate(tqdm(data, desc='Running data', leave=False)):
                try:
                    ...
                    simulation_image = simulation_outputs['images'].squeeze().detach().cpu()
                    ...
                    temp_image_metrics.append(image_metrics)
                    temp_feature_metrics.append(feature_metrics)
                    temp_classifier_metrics.append(classifier_metrics)
        ...
        total_image_metrics.append(temp_image_metrics)
        total_feature_metrics.append(temp_feature_metrics)
        total_classifier_metrics.append(temp_classifier_metrics)
    ...
    torch.save(output, 'new_focal_length_sweep_results.pt')
